...
\label{totalProcurementQuality}
    tProcureQ_{p}= \sum_{c \in C_p} (0.4 \cdot supplierEcoIndex_{c} + 0.6 \cdot supplierQuality_{c}) \cdot baseUtility_{c}
\end{equation}
