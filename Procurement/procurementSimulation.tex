...
All components including their \textit{componentLevel}, the name of the \textit{componentLevel} and their \textit{availabilityDate} can be found in the appendix.\\ %Add reference to table in appendix
