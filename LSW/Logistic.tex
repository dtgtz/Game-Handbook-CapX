...
\gls{dP}   % ecoIndexPartner
\gls{dP}   % qualityIndexLogisticPartner
\gls{dP}   % totalContractualCostLogisticPartner
\gls{dP}   % variableCostDeliveryExternal
\gls{dP}   % reliabilityLogisticPartner
\gls{dP}   % costExternalDelivery 
