...
The original concept was introducing another phase of the game, which would take place from 2018-2030. In this following phase, the company would evolve to a big player like Google, Facebook or Amazon, with the goal to build an environment which allows to control every aspect of people’s lives. 
Moreover, we came up with different modes of game-play. First, the player would start with a normal desktop game. In the second stage the multiplayer mode would be introduced and as the game progresses there would be the possibility to extend to virtual reality. These ideas and more can be found in table \ref{future_work}.
