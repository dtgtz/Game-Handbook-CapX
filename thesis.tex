...
%pricing part. do we need to move it?
...
\begin{tabular}[c]{@{}l@{}}Random or \\ Conditional\end{tabular} & \begin{tabular}[c]{@{}l@{}}Random events have a probability which is not changed throughout the game. \\ Conditional events have some preconditions that must be met to get the probability activated.\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}Rising probability or\\ certain occurence\end{tabular} & \begin{tabular}[c]{@{}l@{}}Probabilities may rise when an influencing indicator gets worse. \\ Alternatively the occurence is certain if a specific threshold is hit.\end{tabular} \\ \hline
...
\textbf{2} & \begin{tabular}[c]{@{}l@{}}New technology \\ increases Quality\end{tabular} & \begin{tabular}[c]{@{}l@{}}A paper from 2010 (cite) examined the relationship\\ between technology and customer satisfaciton\end{tabular} \\ \hline
...
\textbf{10} & \begin{tabular}[c]{@{}l@{}}Stealing inside\\ the company\end{tabular} & \begin{tabular}[c]{@{}l@{}}Research (cite) shows a strong relationship between \\ low job satisfaction and stealing by employees\end{tabular} \\ \hline
...
\textbf{15} & \begin{tabular}[c]{@{}l@{}}Problems with customs \\ at the harbour\end{tabular} & \begin{tabular}[c]{@{}l@{}}The upcoming brexit leads to chaos at harbours due unclear customs. \\ This event is to be further defined when harbours are implemented\end{tabular} \\ \hline
