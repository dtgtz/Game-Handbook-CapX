...
It is recommended to have a look at the following  tutorial  
%after the registration process 
if you have not played Capitalism X before. Also, it might be very helpful to read this game manual, as it gives you a couple of hints about how to handle some situations. The manual at hand gives you an overview about the different buildings and views in the game. Also, it provides you with step-by-step instructions on how to perform the most important activities.
...
% maybe define a BIT more what is meant by "others come around occasionally"? such as earthquakes???
...
% Who screwed up this table again? Took me a long time to fix it -.-
% video tut entry...
\begin{longtable}{|l|l|}
\entering
\hline
