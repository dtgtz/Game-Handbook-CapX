...
\newglossaryentry{tCCLP}{%
name={tCCLP},%
description={totalContractualCostLogisticPartner}%
}
...
\newglossaryentry{nSP}{%
name={nSP},%
description={numberStoredProducts}%
}
\newglossaryentry{sC}{%
name={sC},%
...
\begin{figure}
    \centering
    \includegraphics[scale = 0.28]{images/Tree-like-thing.pdf}
...
Summarized, transferring real-world events is almost never directly possible. The artificial simulated environment must be taken into account. 
