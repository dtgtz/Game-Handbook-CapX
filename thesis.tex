...
Daniel \\
Planning plays an essential part in business, but not everything can be foreseen. Companies and their executives must deal with uncertainty.  
...
There are 18 distinct events divided into 5 categories and acting as counterparts to the game features. In addition, they reflect different areas of of the company's business: 
\begin{table}[]
\begin{tabular}{lll}
\textbf{\#} & \textbf{External Event} & \textbf{Real-World example} \\
\textbf{1} & Production Problems PopUp & \begin{tabular}[c]{@{}l@{}}Not applicable to real-world, \\ In-Game implementation\end{tabular} \\
\textbf{2} & New technology increases Quality & \begin{tabular}[c]{@{}l@{}}A paper from 2010 (cite) examined the relationship\\ between technology and customer satisfaciton\end{tabular} \\
\textbf{3} & Company Aqcuistion offered & \begin{tabular}[c]{@{}l@{}}High-Performing companies like Apple often\\ invest in smaller ones to buy knowledge\end{tabular} \\
\textbf{4} & Large company overtakes market share & \begin{tabular}[c]{@{}l@{}}The launch of the iPhone led to whole\\ change of the mobile phone market\end{tabular} \\
\textbf{5} & Company Brand reputation plunges & \begin{tabular}[c]{@{}l@{}}After the failure of several Airbags \\ sales of GM dropped dramatically\end{tabular} \\
\textbf{6} & Computer virus attacks & \begin{tabular}[c]{@{}l@{}}In 2017 Maersk encountered a cyberattack\\ corrupting operations with a damage of 300 m€\end{tabular} \\
\textbf{7} & Tax Changes lead to higher or less rates & \begin{tabular}[c]{@{}l@{}}The US and 7 EU countries changed \\ their corporate tax rates for 2018\end{tabular} \\
\textbf{8} & Stricter Eco Laws & \begin{tabular}[c]{@{}l@{}}As a result of the Diesel scandal many \\ countries enforced the environmental laws\end{tabular} \\
\textbf{9} & Inflation changes & \begin{tabular}[c]{@{}l@{}}Destatis reported an average inflation \\ change of during the last 20 years of 1.4\%\end{tabular} \\
\textbf{10} & Stealing inside the company & \begin{tabular}[c]{@{}l@{}}Research (cite) shows a strong relationship between \\ low job satisfaction and stealing by employees\end{tabular} \\
\textbf{11} & Strikes and union fightings & Strikes occur regularly to enforce salary increases \\
\textbf{12} & Flu goes around causing Ill employees & \begin{tabular}[c]{@{}l@{}}Disease rates are higher during winter months \\ making employees ill and unable to work\end{tabular} \\
\textbf{13} & Hurricanes, tornados, earthquakes & \begin{tabular}[c]{@{}l@{}}Hurricanes regularly destroy companies' inventories. Global \\ warming is claimed to increase the number of natural disasters\end{tabular} \\
\textbf{14} & Fire / Flooding in warehouse & \begin{tabular}[c]{@{}l@{}}Over 1,210 fires happen in warehouses across the US on average.\\ In the game this only happens if warehouses are full (punishment)\end{tabular} \\
\textbf{15} & Problems with customs at the harbour & \begin{tabular}[c]{@{}l@{}}The upcoming brexit leads to chaos at harbours due unclear customs. \\ This event is to be further defined when harbours are implemented\end{tabular} \\
\textbf{16} & Change of power & \begin{tabular}[c]{@{}l@{}}New governments set new financial priorities including changes \\ to the taxation system. Typical examples are the parties in the US\end{tabular} \\
\textbf{17} & Blocked roads beacause of riots & \begin{tabular}[c]{@{}l@{}}Exact indicators are future work as infrastructure elements are \\ not part of the game yet. Energy companies are often targets of riots\end{tabular} \\
\textbf{18} & Tensions between our country and other countries & \begin{tabular}[c]{@{}l@{}}Tensions between the US and Iran impact companies on their business. \\ Part of future work as the game currently focuses at one country.\end{tabular}
\end{tabular}
\end{table}
\begin{itemize}
...
<table event to real world example>
...
3 & \begin{tabular}[c]{@{}l@{}}Company Acquisition \\ possibility offered\end{tabular} & Conditional & \begin{tabular}[c]{@{}l@{}}Constant \\ Increasing \\ Revenue\end{tabular} & n/a & \begin{tabular}[c]{@{}l@{}}Revenue increases\\ 25\% per year \\ over 5 years\end{tabular} &  & \begin{tabular}[c]{@{}l@{}}Indicators of \\ Acquisition integrated\end{tabular} & \begin{tabular}[c]{@{}l@{}}Acquisition costs xy, \\  mini-game possible\end{tabular} \\ \hline
...
13 & \begin{tabular}[c]{@{}l@{}}Hurricanes, tornadoes, \\ earthquakes\end{tabular} & Conditional & \begin{tabular}[c]{@{}l@{}}Eco \\ Index\end{tabular} & 2 & 0.12 * Eco Index \textasciicircum 1.3 & 5 &  Inventory &  \\ \hline
14 & \begin{tabular}[c]{@{}l@{}}Fire / Flooding in \\ warehouse\end{tabular} & Conditional & Inventory & \begin{tabular}[c]{@{}l@{}}Warehouses \\ at 80\%\end{tabular} & Game Cycles *0,001 & \begin{tabular}[c]{@{}l@{}}100 Game \\ Cycles\end{tabular} & Inventory & \begin{tabular}[c]{@{}l@{}}Only if warehouse\\ at or over 80\% full\end{tabular} \\ \hline
