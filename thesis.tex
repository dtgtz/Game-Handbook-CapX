...
This project at hand is a concept of a business simulation game called "CapitalismX". The first two chapters constitute a user manual for a potential player of the game, explaining the what to expect of the game, what role the player has and how to play the game. The third chapter addresses the game mechanics which are even mostly tested by the game prototype. 

However, the concept as described in chapter 3 contains more functionality than the prototype currently provides. If some functionality is not covered in the prototype, this is mentioned in the respective simulations. The core of all simulations is the [overall / full Graph], which can be found in figure \ref{fig:OverallGraph}. This graph combines all simulations and serves as a basis for the prototype. 
...
Ath like: original concept was introducing another phase of the game, which would take place from 2017-2030(?) with VR and mobile integration, xxx. 
