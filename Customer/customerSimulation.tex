...
% add: totalSalesPeopleQualityofWork
...
\label{cSCalc}
    ...
    & = tanh(\dfrac{(0.5 \cdot tOA_{cS} + 0.2 \cdot tSQ + 0.1 \cdot lI + 0.15 \cdot cI + 0.05 \cdot eB)}{100}) %value must be defined!
\end{aligned}   
\end{equation}
