...
The right sidebar in the finance dashboard provides a graphical overview of the key figures sales, salaries and loans per quarter. The last four quarters are displayed as a line graph. This allows the player to easily view facts and changes over time and make timely business decisions. 
