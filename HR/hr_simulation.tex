...
%maybe add min and max of employee satisfaction? because without, "below 50" appears a bit weird.
...
%ABOVE THERE IS JOB SATISFACTION 50 MENTIONED???
...
% SKILL LEVEL IN ITALIC FONT??? AND MAYBE THE FIRST ITEM AS AN EQUATION? LETS TALK ABOUT THIS TOGETHER
\begin{itemize}
